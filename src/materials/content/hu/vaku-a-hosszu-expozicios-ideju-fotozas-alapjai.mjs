...
export default function Article() {
    ...
    <p>Amikor találkozunk az expozíciós háromszöggel (zársebesség, rekesz, érzékenység) fontos, hogy megértsük mindhárom tényező fontosságát a kép elkészítésében. A rekesz felel a megfelelő mélységélességért, az ISO a színmélységért és a megfelelő fény érzékenységért, a zársebesség pedig a mozgás mértékért.
        <br /> Ha belegondolsz sok esetben a mozgás az ami feszültséget kelt vagy érzelmet vált ki egy kép láttán. Hagyd a zársebességet hosszúra és megragadod a téma mozgását, áramlását így adva lendületet, sokszor álomszerű hatást a képnek.</p>
    <${SimpleFigure} fileName="20160305_Iceland_4823-Edit-2-1280x860-1-1024x688.jpg" alt="Illusztráció" />
    ...
    <p><em>A hosszú expozíciós fotózás különböző vállfajaihoz különböző technikák szükségesek. Nézzük meg a legnépszerűbbeket.</em></p>
    ...
    <p><strong>Az ideális beállítás Colby szerint:</strong> ISO100 / F/11 / 0,5-2 mp</p>
    ...
    <p><strong>Keress olyan vonalakat amik vezetik a szemet!</strong> A néző tekintetét könnyebb a kép lényegére fókuszálni ha ezek a vonalak a téma felé vezetnek. Például egy út ami végigviszi a néző szemét az egész képen ezáltal felfedezhet finom rejtett részleteket.</p>
    <${SimpleFigure} fileName="DX_7114-Edit-Recovered-1024x682-1024x682.jpg" alt="Illusztráció" />
    <p><strong>Ne ijedj meg álló formátumú képek készítésétől sem:</strong> Sok fotós ragaszkodik a fekvő formátumhoz, de az álló képekkel még nagyobb mélységet lehet kölcsönözni a képeinkbe. Olyan hatást kelt mintha ott lennénk.</p>
    ...
    <p><strong>Próbáld meg minden esetben fényképezőgéped és objektívjeid megmenteni a sós víztől!</strong></p>
    ...
    <p><strong>Az ideális beállítás Colby szerint:</strong> ISO100 / F/11 – F/16 / változó zársebesség</p>
    ...
    <h4>Tippek és trükkök</h4>
    <p><strong>Használj gumicsizmát:</strong> Nem csak a felszerelés megóvása a fontos, de a gumicsizma segítségével könnyen szárazon tartható a lábunk. Nagyon fontos a felszerelésed óvd a sós víztől.</p>
    <${SimpleFigure} fileName="BrianMatiash_20150227-DSC04589-1-1024x683-1024x683.jpg" alt="Illusztráció" />
    <p><strong>Az időzítés kulcsfontosságú: </strong> Amikor mozgó tárgyakat fotózunk az időzítés kulcsfontosságú. Colby gyakran készít 6-7 expozíciót egy sorozatban ahogy egy hullám jön majd visszavonul a tengerbe. Minden kép más és más, nincs két egyforma.</p>
    ...
    <p><strong>Az ideális beállítás Colby szerint:</strong> ISO100 / F/2.8 – F/11 / hosszú zársebesség</p>
    ...
    <h4>Tippek és trükkök</h4>
    <p><strong>A kék óra a Te barátod:</strong> Colby egyik kedvenc időszaka a városképek elkészítéséhez a kék óra azaz a naplementét követő egy óra. A nappal és éjszaka átmenete között könnyű megtalálni az egyensúlyt a megfelelő fényhez és kontraszthoz.</p>
    <${SimpleFigure} fileName="DX_1515-Edit-Edit-2-1024x683-1024x683.jpg" alt="Illusztráció" />
    <p><strong>Az emberek legyenek mozgásban a képen:</strong> Sok fotós megpróbálja eltávolítani az embereket a képről. Tedd a géped egy állványra válassz egy hosszú záridőt és használd ki a képed drámaibbá tételéhez az emberek elmosódott mozgását.</p>
