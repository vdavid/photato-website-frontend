...
export default function Article() {
    ...
    <p>További képek és részletesebb tanácsok <${ExternalLink} href="http://johnbatdorff.com/blog/2011/11/10/simple-ways-to-improve-your-street-photography/">John Batdorff honlapján</a>.</p>
</div>`;
}