...
<p>Egy <strong>hosszú záridős fotót</strong> várunk tőled, amit <${PhotoUploadLink} label="itt tudsz feltölteni" />. Kedden közös fotózós esemény lesz, <${ExternalLink} href="https://www.facebook.com/events/2265483047079220/">jelentkezz itt!</a></p>
...
<ol>
    ...
    <li><strong>Ha kell, használj ND szűrőt.</strong> Ha sok a fény és elkötelezett fotós vagy, csökkentsd a gépbe jutó fény mennyiségét egy megfelelő <${ExternalLink} href="https://pixinfo.com/cikkek/objektiv-szurokrol-egyszeruen/">természetes szürke szűrővel</a>.</li>
    <li><strong>+1: Gyere velünk fotózni a Margitszigetre!</strong> Az előző tanfolyamokon a hosszú záridős képek bizonyultak a legtöbb embernek az egyik legnehezebbnek, ezért ezen a héten szeretnénk segíteni nektek a közösség erejével. <${ExternalLink} href="https://www.facebook.com/events/2265483047079220/">Jelentkezz itt</a> a keddi eseményre!</li>
</ol>

<p>6 link további infókkal és ötletekkel – érdemes őket megnézni:</p>

<ul>
    <li><${ExternalLink} href="https://vaku.hu/2017/07/25/a-hosszu-expozicios-ideju-fotozas-alapjai/">A hosszú záridős fotózás alapjai</a></li>
    <li><${ExternalLink} href="http://fotopiac.hu/bemozdulni-vagy-bemozditani/">Bemozdulni vagy bemozdítani?</a></li>
    <li><${ExternalLink} href="http://indafoto.blog.hu/2011/05/19/fenycsikok_hosszu_zaridovel">Fénycsíkok hosszú záridővel</a></li>
    <li><${ExternalLink} href="https://www.canon.hu/get-inspired/tips-and-techniques/how-to-control-exposure/">Az expozíció beállításairól a Canontól</a></li>
    <li><${ExternalLink} href="http://www.tripont.hu/problog/2625/capture_one_pro_10__a_fenyelhajlas_tobbe_nem_okoz_gondot">A nagyon szűk blende problémája: a fényelhajlás</a></li>
    <li><${ExternalLink} href="https://pixinfo.com/cikkek/objektiv-szurokrol-egyszeruen/">ND szűrő, egyéb szűrők</a></li>
</ul>

<p>Kreatív feladatok, variációk, érdekességek:</p>
<ul>
    <li>Fess fénnyel (<${ExternalLink} href="https://hu.pinterest.com/search/pins/?rs=ac&len=2&q=light%20painting%20photography">inspiráció</a>)</li>
    <li>Vakuzz közbe</li>
    <li>Készíts gif-et több képből</li>
</ul>

<p>Inspiráció: <${ExternalLink} href="https://hu.pinterest.com/search/pins/?q=long%20exposure">Pinterest hosszú exponálási idő</a> | <${ExternalLink} href="https://hu.pinterest.com/search/pins/?q=light%20painting%20photography">Pinterest fényfestés</a> | <${ExternalLink} href="https://pixinfo.com/cikkek/igy-fotozz-este-es-ejszaka/">Pixinfo: fotózás sötétben</a></p>
