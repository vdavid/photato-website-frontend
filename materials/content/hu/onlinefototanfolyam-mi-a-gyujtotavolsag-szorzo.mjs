...
export default function Article() {
    // noinspection SpellCheckingInspection (It's in Hungarian.)
    return html`<div>
    <p>Nehéz téma és sok a visszatérő kérdés:
    <ul>
    ...
    <p><em>(Az érthetőség kedvéért nem fejtek ki mindent szakszavakkal, megpróbálok egyszerűsíteni, úgy leírni ezt a cikket, hogy könnyen emészthető legyen. Bár a téma nem az.)</em></p>
    ...
    Az egyre kisebb fényképezőgépekhez pedig egyre kisebb objektíveket és <strong>egyre kisebb szenzort</strong> kell/lehet készíteni.</p>
    ...
    <p>Kezdjük az elején, menjünk vissza időben a negatívra dolgozó kisfilmes (más néven 135-ös, vagy 35 mm-es) fényképezőgépekhez. Az amatőr, a tükörreflexes és a professzionális fényképezőgépek körében is a 24x36 mm-es negatív film volt a legelterjedtebb, vagyis erre a filmre dolgoztak a fényképezőgépek. <br />
     (A 24x36 mm egy negatív kocka méretét jelenti.) Az objektívek pedig ehhez a film mérethez készültek!</p>
    ...
    (Ennek azért van jelentősége, mert a Full Frame szenzorméretű fényképezőgéphez készült objektíveket ugyanazon márkán belül, tudjuk kisebb, például APS-C szenzorméretű fényképezőgépen is használni.)</p>
    ...
    - Például egy 50 mm-es alap objektív mindkét fényképezőgépen ugyanúgy fog viselkedni.</p>
    ...
    <h2>FONTOS:</strong> Az előbb említett példa ugyanarra a objektívre vonatkozik két különböző szenzorméretű h2>
    <p>Azért, hogy jobban alkalmazkodjunk az eltérő szenzorméretű fényképezőgépeken található gyújtótávolság jelöléshez, <br />
    vagyis azért, hogy átszámolva tudjuk mihez hasonlítani a kisebb szenzorméretű fényképezőgépek objektíveinek gyújtótávolságát a kisfilmes fényképezőgépekhez képest, itt egy táblázat néhány gyújtótávolság szorzóról.</p>
