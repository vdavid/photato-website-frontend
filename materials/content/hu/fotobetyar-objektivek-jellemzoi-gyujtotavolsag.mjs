...
export default function Article() {
    ...
    <p>A képkészítéshez nélkülözhetetlen objektíveknek számtalan fontos tulajdonsága van: <strong>gyújtótávolság, fényerő, rajzolat,</strong> amelyekell jobb baráti viszonyt ápolni.</p>
    ...
    <p><strong>…“oké, de mi ez a gyújtótávolság?!” </strong>kérdezheted jogosan</p>
    <p><strong>A hivatalos elmélet és magyarázat:</strong></p>
    ...
    <p>Viszont optikai szempontból mindig lehet <strong>egy üvegtaggal/lencsével helyettesíteni</strong> egy összetett rendszert is (lásd alábbi ábra).</p>
    ...
    <p>Nagyon kérünk ne kérdezd, hogy <strong>miért nem látószögben mérjük/mondjuk</strong> ezt az értéket… ez terjedt el, ezt használja mindenki, ez a divat, mint vadnyugaton a pisztoly meg a pantalló.</p>
    <p>Elég ritkán fogalmazunk úgy, hogy vettem egy 46 fokos látószögű objektívet, viszont a “<strong>vettem egy 50-es alapobjektívet</strong>” teljesen hétköznapi kijelentés (mindig hétköznap veszünk alapobjektívet ;-).</p>
    ...
    <p><strong>Létezik belőle: </strong></p>
    <ul>
        <li>Fix</li>
        <li>Zoom</li>
        <li>Makró</li>
    ...
    <p><strong>Nézzünk pár tipikus gyújtótávolságot</strong> és hogy mikor használjuk. Figyelem az esztétikában az a szabály, hogy nincs szabály. Mindent lehet és annak az ellenkezőjét is. Allábiakat ne egzakt törvényként kezeljétek!!</p>
    ...
    <p><strong>Jellemző gyújtótávolságuk: 16-24-35mm</strong></p>
    ...
    <p>Ez nagyjából a <strong>második legfontosabb tulajdonsága</strong> az optikának. <strong>Minél fényerősebb az optika, annál több fényt képes összegyűjteni</strong> (és annál többe kerül). A fényerőt a legtágabb blende értékkel mérjük/jellemezzük és <strong>minél kisebb ez a szám, annál jobb az eszköz fényereyeee</strong>. Pl.: Egy 1,4-es fényerejű objektív jobb/fényerősebb, mint egy 4-es fényerejű.</p>
    <p>Amúgy a fényerő egy <strong>arányszámot jelöl</strong> és azt mutatja, hogy hogyan aránylik a gyújtótávolság az átmérőhöz. Pl: Egy 1-es fényerejű optikához ha 50mm-es a gyújtótávolsága akkor 50mm-es átmérőre van szűkség. <strong>Fényerő= Gyújtótáv/(osztva)Átmérő.</strong> Másik példa: 200mm-es teleobjektívnek 2-es a fényereje, ha 100mm az átmérője &gt;&gt; 200/100=2. Lásd alábbi képen is.</p>
