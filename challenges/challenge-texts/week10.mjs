...
<p>Ha még nem küldted be a múlt heti (portré) képedet, ma éjfélig még azt is ${await createPhotoUploadLink('megteheted')}. 🕚</p>
<p>Az eseményfotókat pedig ${await createPhotoUploadLink('itt várjuk')}!</p>
<p>Jó fotózást,</p>
<p>--<br />
    a Photato csapata</p>`;
}