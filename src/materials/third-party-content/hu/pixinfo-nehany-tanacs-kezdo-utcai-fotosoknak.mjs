...
export default function Article() {
    // noinspection SpellCheckingInspection (It's in Hungarian.)
    return <>
        <p>Egy korábbi <ExternalLink href="https://pixinfo.com/hirek/2012/01/03/fekete-hattyu-az-utcan-avagy-mi-a-titka-a-street-photography-nek/">postunkban</ExternalLink> [<NavLink to="/hu/external-article/pixinfo-fekete-hattyu-az-utcan-avagy-mi-a-titka-a-street-photography-nek">Photato mentett verzió</NavLink>] már foglalkoztunk a street photography műfajjal, most újra elővesszük. Igaz ugyanis a mondás, több szem, többet lát. Lássuk, John Batdorff milyen tanácsokkal szolgál a kezdő utcai fotósoknak. A fotográfia egy viszonylag szűk rétegét képezi a bizonyos szempontból szociofotózásnak is tekinthető utcai fotózás, vagy angol nyelvén street photography. A legtöbbször meg nem ismételhető, érdekes, meglepő, vagy éppen meghökkentő pillanatokat elcsípő utcai fotózás nem tartozik a könnyű műfajok közé. Tárgyfotózni, makrózni és portrézni is könnyebb, mint az utcai fotózás. Ezek ugyanis előre jól eltervezhetők. Nem úgy az utcai fotózás, ahol az adott pillanatot vagy elkapod, vagy nem. Persze lehet kivárni is és arra játszani, hogy megtörténik újra.
        </p>
        ...
        <p>Ennyi. Lehet, hogy tényleg elég is.<br/>
            Egy dolgot azonban szerintem kifejeltettünk, bár ez nyilván nem tanács kérdése, s ezt már én teszem hozzá:
        </p>
        <ul>
        ...
        <p>További képek és részletesebb tanácsok <ExternalLink href="http://johnbatdorff.com/blog/2011/11/10/simple-ways-to-improve-your-street-photography/">John Batdorff honlapján</ExternalLink>.
        </p>
    </>;
}