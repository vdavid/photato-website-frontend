...
<ol>
    ...
    <li><strong>Állítsd be a kamerád.</strong> Ha kell, használj szűkebb <a href="https://fotozasblog.hu/digitalis-fotozas/#melysegelesseg">blende</a> beállítást, hogy nagyobb legyen az éles tartomány. Itt egy <a href="/challenges/linked-images/depth-of-field.gif">gif a mélységélességről</a>.</li>
...
<ul>
    ...
    <li><strong>Plankelj.</strong> Milliószor ugyanúgy lefotózott híres épületek? <a href="/challenges/linked-images/washington.jpg">Feküdj be a képbe</a>.</li>
</ul>
