...
<ul>
    ...
    <li><strong>Plankelj.</strong> Milliószor ugyanúgy lefotózott híres épületek? <ExternalLink href={baseUrl + '/challenges/linked-images/washington.jpg'}>Feküdj be a képbe</ExternalLink>.</li>
</ul>
