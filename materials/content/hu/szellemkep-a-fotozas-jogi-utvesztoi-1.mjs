...
export default function Article() {
    ...
    <p><em>(<${NavLink} to="/external-article/szellemkep-a-fotozas-jogi-utvesztoi-2">Következő írásunkban</NavLink> az engedély nélküli fotózás szankcióit mutatjuk be, és megpróbálunk tanácsot adni a helyes eljárásra is.)</em></p>
</div>`;
}