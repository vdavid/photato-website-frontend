...
export function getMetadata() {
    ...
    return {
        slug: 'sg-makrofotozas-2',
        title: 'Makrofotózás II.',
        author: 'Gábor Zoltán',
        publishDate: new Date('2006-05-15'),
        publisherName: 'Sg.hu',
        originalUrl: 'https://sg.hu/cikkek/44443/hogyan_fotozzunk_makrofotozas_ii',
...
export default function Article() {
    ...
    <${TwoEnlargeableFigures} thumbnailFileName1="0504_makro9_200.jpg" fullSizeFileName1="0504_makro9.jpg" altText1="Makró 9" caption1="Digitális tükörreflexes géppel és fordított objektívvel készült felvétel" thumbnailFileName2="0504_makro10_200.jpg" fullSizeFileName2="0504_makro10.jpg" altText2="Makró 10" caption2="Digitális tükörreflexes géppel és fordított objektívvel készült felvétel" />
   <p>Haladó fotósok egy fordítógyűrű segítségével akár fordítva is felcsavarhatják általános célú objektívjüket, ezzel pedig igazán extrém mértékű nagyításokat érhetnek el, manuális fókusz és nem működő fénymérés mellett (de ezek működtetéséhez is vannak barkács megoldások). Akinek nincs pénze drága makroobjektívre, de van egy jó minőségű általános célú fix objektívje (vagy akár makroobjektívje), az egy úgynevezett közgyűrűsorral makroképességekkel ruházhatja fel objektívjét. Akiknek fontos az AF és a fénymérés használata, azok ilyet válasszanak gépük és az objektív közé.</p>
    <h2>Általános tanácsok</h2>
    <p>Tanuljuk meg, hogy makrofotózásnál a mélységélesség nagyon lerövidül. Kompaktosok előnyben vannak a DSLR vázakkal szemben, hiszen a kompaktoknál azonos rekeszértéknél jóval nagyobb a mélységélesség, de még így is elég kicsi lesz. Komolyabb makroobjektíveknél a mélységélesség csupán pár centiméterre csökken. Ha fordítva helyezzük fel az objektívet a vázra, a mélységélesség csak pár milliméteres lesz, így ilyen esetekben van a legnehezebb dolgunk. Ha komoly nagyítású felvételt készítünk a természetben, akkor megyünk biztosra, ha sorozatfelvételi módban fényképezünk. Ilyenkor a témák és a saját mozgásunk miatt elcsúszhat, rossz helyre kerülhet a fókusz, tehát jobb, ha egyből több képet készítünk, hátha az egyiken helyes lesz a fókuszpont. Állvány használata erősen javallott!</p>
    <${TwoEnlargeableFigures} thumbnailFileName1="0504_makro11_200.jpg" fullSizeFileName1="0504_makro11.jpg" altText1="Makró 11" caption1="Digitális tükörreflexes géppel készült felvétel" thumbnailFileName2="0504_makro12_200.jpg" fullSizeFileName2="0504_makro12.jpg" altText2="Makró 12" caption2="Digitális tükörreflexes géppel készült felvétel" />
    <p>Próbáljuk meg témáinkat nem mindig középre komponálni. Előfordulhat, hogy jobb kompozíció születik, ha többet mutatunk az elmosódott háttérből (figyeljünk az aranymetszésre). Rovarok fotózásánál próbáljunk tele állásban fotózni, hiszen a legtöbb rovar nem engedi túl közel magához a gépünket. A virágok, növények fényképezésénél is ügyeljünk az érdekesebb beállításra. Ne csupán egy fotót készítsünk az adott növényről, keressünk több, eredetibb nézőpontot.</p>
    <p>Rengeteg vágatlan, felesleges információt tartalmazó kép özönli el a világhálót, amiknek csupán egy kis százalékát foglalja el a fotótéma csupán azért, mert lusták vagyunk megvágni fotóinkat. Igyekezzünk gépünk teljes felbontását kihasználni. Ne legyünk restek kisebbre szabni a képeket, hiszen a ma divatos 5-8 megapixeles képekből bőven van lehetőségünk vágni, ha esetleg a fotóalanyunkról nem tudtunk elég nagy fotót készíteni. Érdemes odafigyelni gépünk árnyékára is, ha lehet, ne takarjuk el a fényt a témáról az objektívünkkel.</p>
</div>`;
}