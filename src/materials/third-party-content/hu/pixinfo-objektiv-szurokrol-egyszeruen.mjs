...
export default function Article() {
    ...
    return <>
        ...
        <h2>Effekt szűrők</h2>
        <p>Különleges szűrőket sorolhatunk az effekt szűrők kategóriába, ahol az objektívre feltekerhető szűrőkön kívül meg kell említenünk a <ExternalLink href="https://pixinfo.com/cikkek/cokin_filter">lapszűrőket</ExternalLink> is. Az effekt szűrők között átmenetes szürke, vagy átmenetes színes szűrőket találhatunk, amelyekkel pl. az égbolt felső részét sötétíthetjük, vagy színezhetjük ki, míg a horizont alatti területet érintetlenül hagyhatjuk. Az ilyen feladatokra mozgathatóságuk miatt a lapszűrők alkalmasabbak.
        </p>
