...
export default function Article() {
    ...
    return <>
        ...
        <table>
            <tbody>
            <tr>
                <th>Fényképezőgép szenzormérete</th>
                <th>Az a rekeszérték, amikortól a fényelhajlás befolyásolni kezdi az élességet</th>
            </tr>
            <tr>
                <td>1” érzékelő: 20 MP</td>
                <td>5.6</td>
            </tr>
            <tr>
                <td>APS – C: 24 MP</td>
            ...
            <tr>
                <td>Full frame 35 mm: 42 MP</td>
                <td>11</td>
            </tr>
            <tr>
                <td>Középformátum: 60MP</td>
                <td>12</td>
            </tr>
            <tr>
                <td>Középformátum: 100MP</td>
                <td>11</td>
            </tr>
            </tbody>
        </table>

        <h2>Egy példa a fényelhajlásra<ExternalLink href="http: //blog.phaseone.com/compensate-lost-sharpness-small-apertures/skaermbillede-2017-01-26-kl-14-11-23/"><br/></ExternalLink>
        </h2>
